...
SECRET_KEY = '()_)ppv-q$6g7ukvks6udj5n#2-bmazav4v43k#zw(ricck-&!'
...
LOGIN_URL = '/OnlineFiveinaRow/login'

# Default URL to redirect to after a user logs in.
LOGIN_REDIRECT_URL = '/OnlineFiveinaRow/'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'OnlineFiveinaRow')
